...
ALTER TABLE advertisement ADD CHECK (price > 0);
ALTER TABLE advertisement ADD CHECK (mileage > 0);
ALTER TABLE advertisement ADD CHECK (date_of_publication_of_advertisement <= CURRENT_TIMESTAMP);
